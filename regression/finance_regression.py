...
reg1 = reg1.fit(feature_test, target_test)

### get the slope
### again, you'll get a 2-D array, so stick the [0][0] at the end
slope = reg1.coef_[0] ### fill in the line of code to get the right value

### get the intercept
### here you get a 1-D array, so stick [0] on the end to access
### the info we want
intercept = reg1.intercept_ ### fill in the line of code to get the right value

### get the score on the training data
training_score = reg1.score(feature_train, target_train)

### get the score on the test data
test_score = reg1.score(feature_test, target_test)
